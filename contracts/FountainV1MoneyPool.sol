...
import "./interfaces/IFountainV1MoneyPool.sol";
...
//TODO instead, consider each project having a MP.
contract FountainV1MoneyPool is IFountainV1MoneyPool {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    modifier onlyFactory() {
        require(msg.sender == factory, "Only reachable by the Factory");
        _;
    }
    ...
    enum State {Pending, Active, Redistributing}

    // The number of MoneyPool.
