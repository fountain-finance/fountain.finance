...
This mimics an overflowing fountain effect where a water stream directed at a top surface can end up overflowing the pools of each layer beneath ⛲️, so long as the boundaries of the pools are defined ahead of time.
